const SOURCE_URL = 'https://raw.githubusercontent.com/azwadpr-ship-it/damascene-links/main/ChatGPT2010202026%D8%8C20.png';
  ...
  try {
    if (!cachedImage) {
      const response = await fetch(SOURCE_URL, {
        headers: { 'User-Agent': 'damascene-links-social-preview-v5' }
      });
