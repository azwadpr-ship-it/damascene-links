...
function loadReport(){
 ...
 loading=new Promise((resolve,reject)=>{
  const old=document.getElementById('report-v32-v66-js');
  ...
  const s=document.createElement('script');s.id='report-v32-v66-js';s.src='/inventory/report-v32.js?v=66';s.async=false;s.onload=resolve;s.onerror=()=>reject(new Error('تعذر تحميل قالب التقرير'));document.body.appendChild(s)
 });
 return loading
}
